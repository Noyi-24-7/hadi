...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2E2625);
  late Color secondary = const Color(0xFF1F3F28);
  late Color tertiary = const Color(0xFFA55954);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF2A2525);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF1F4F8);
  late Color accent1 = const Color(0xFFE9F3F7);
  late Color accent2 = const Color(0x93E4C694);
  late Color accent3 = const Color(0x7AE0E67A);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF3E7D6A);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF6534);
