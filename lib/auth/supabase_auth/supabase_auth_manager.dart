...
class SupabaseAuthManager extends AuthManager with EmailSignInManager {
    ...
    String password,
      ...
      _signInOrCreateAccount(
        ...
        () async {
             ...
             // MOCK MODE CHECK
             // ignore: undefined_identifier
             if (AppConfig.isMockMode) { // Temporary direct check while AppConfig imports propagate or for quick audit
  ...
  Future<BaseAuthUser?> signInWithPhone(
    BuildContext context,
    String phoneNumber,
    String password,
  ) =>
      _signInOrCreateAccount(
        ...
        () async {
             ...
             return SupaFlow.client.auth.signInWithPassword(
               phone: phoneNumber,
               password: password,
             ) as Future<User?>;
        },
  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      final authUser = user == null ? null : HadiSupabaseUser(user);
